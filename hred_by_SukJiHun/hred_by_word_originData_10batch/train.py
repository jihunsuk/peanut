...
def train(dialog, batch_size=15, epoch=100):

    model = Hred(dialog.voc_size, True, 15)
    with tf.Session() as sess:
        ...
        # 학습시작.
        total_batch = int(math.ceil(len(dialog.seq_data)/(float(batch_size)*15)))
